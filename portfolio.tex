...
\begin{itemize}
    \item een overzicht van mijn \textbf{werkervaring}, inclusief relevante functies, projecten en verantwoordelijkheden;
    \item een opsomming van mijn \textbf{opleiding(en)} en behaalde certificeringen;
    \item een beschrijving van mijn \textbf{vaardigheden}, zowel technisch als persoonlijk;
    \item mijn \textbf{stage-ervaringen}, inclusief werkzaamheden en geleerde competenties;
    \item mijn \textbf{persoonlijke informatie} en contactgegevens;
    \item een korte toelichting op mijn \textbf{hobby’s} en interesses die bijdragen aan mijn professionele profiel.
\end{itemize}
